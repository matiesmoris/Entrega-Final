...
from AppCoder.views import mostrar_mi_template, mostrar_mis_tareas, mostrar_personas, crear_persona, BuscarPersonas
from SocialTravel.views import (index, PostList, PostDetail, PostCreate, PostUpdate,
 PostDelete, SignUp, Login, Logout, ProfileUpdate, MensajeCreate, MensajeDelete, MensajeList)
